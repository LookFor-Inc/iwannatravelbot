...
//
//    public InlineKeyboardMarkup getInlineKeyBoardMarkup(String countryName) {
...
//            inlineKeyboardButton1.setCallbackData("from " + countryName);
//            rowBtns.add(inlineKeyboardButton1);
//
//            InlineKeyboardButton inlineKeyboardButton2 = new InlineKeyboardButton();
//            inlineKeyboardButton2.setText(countries.get(finalI + 1).getRu());
//            inlineKeyboardButton2.setCallbackData("from " + countryName);
